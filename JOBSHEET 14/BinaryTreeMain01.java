public class BinaryTreeMain01 {
     public static void main(String[] args) {
        ...
        // Tugas 1: addRekursif
        BinaryTree01 bst2 = new BinaryTree01();
        bst2.addRekursif(new Mahasiswa01("244160121", "Ali", "A", 3.57));
        bst2.addRekursif(new Mahasiswa01("244160221", "Badar", "B", 3.85));
        bst2.addRekursif(new Mahasiswa01("244160185", "Candra", "C", 3.21));
        bst2.addRekursif(new Mahasiswa01("244160220", "Dewi", "B", 3.54));
        bst2.addRekursif(new Mahasiswa01("244160131", "Devi", "A", 3.72));
        bst2.addRekursif(new Mahasiswa01("244160205", "Ehsan", "D", 3.37));
        bst2.addRekursif(new Mahasiswa01("244160170", "Fizi", "B", 3.46));
        System.out.println("\nTugas 1 - Hasil addRekursif (InOrder):");
        ...
        System.out.println("\nTugas 3 - Tampil Mahasiswa IPK di atas 3.50:");
